    ...
    <section className="min-h-screen flex items-center justify-center px-4 bg-gray-50">
      <div className="text-center max-w-4xl mx-auto">
        ...
        <div className="mb-16">
          <Button 
            size="lg" 
            className="bg-blue-500 hover:bg-blue-600 text-white px-12 py-6 text-xl font-medium rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg"
          >
            Create Payment Link
          </Button>
        </div>
