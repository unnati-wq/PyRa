        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="lg:col-span-2">
            <div className="mb-6">
              ...
              <p className="text-purple-300 font-light mt-1">Era of Programmable Payments</p>
            </div>
        ...
        <div className="bg-white/5 rounded-2xl p-8 mb-12 border border-white/10">
          <div className="text-center">
            ...
            <div className="flex gap-4 max-w-md mx-auto">
              ...
              />
              <button className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-3 rounded-full hover:from-purple-700 hover:to-blue-700 transition-all duration-300 font-semibold">
                Subscribe
              </button>
            </div>
          </div>
